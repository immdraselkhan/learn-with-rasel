...
const UserContext = ({children}) => {
  ...
  return (
    <AuthContext.Provider value={{user, googleProvider, twitterProvider, githubProvider, signupWithEmailPassword, logInWithEmailPassword, logInWithPopup, verifyEmail, passwordResetEmail, updateUserProfile, userLogOut, loading, setLoading}}>
      {children}
