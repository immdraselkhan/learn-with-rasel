            ...
            <div className='space-y-1'>
              ...
              <span className='flex items-center space-x-2 w-full'>
                <span className='text-gray-400 text-small'>
                  Email Status: <span className='text-green-400'>{user?.emailVerified ? 'Email Verified' : (user?.email && !user?.emailVerified ? 'Verification email sent!' : 'Email not found')}</span>
                </span>
              </span>
              <span className='flex items-center space-x-2 w-full'>
